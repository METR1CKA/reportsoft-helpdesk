        ...
        <div class="p-6 text-gray-900 dark:text-gray-100">
          <form method="post" action="{{ route('enterprises.create') }}">
            ...
            <div class="mt-4">
              ...
              <x-text-input id="contact_email" class="block mt-1 w-full" type="text" name="contact_email" :value="old('contact_email')" required autocomplete="contact_name" />
            ...
            <div class="mt-4">
              ...
              <x-text-input id="contact_phone" class="block mt-1 w-full" type="tel" name="contact_phone" :value="old('contact_phone')" required autocomplete="contact_phone" />
            ...
            <div class="mt-4">
              ...
              <x-text-input id="legal_id" class="block mt-1 w-full" type="text" name="legal_id" required autocomplete="legal_id" />
            ...
            <div class="mt-4">
              ...
              <x-text-input id="legal_name" class="block mt-1 w-full" type="text" name="legal_name" required autocomplete="legal_name" />
